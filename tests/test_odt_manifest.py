...
def basic_odt_manifest_path(fix_xml_path_path: Path) -> Path:
    return fix_xml_path_path("basic_odt_manifest.xml")

@pytest.fixture(scope="session")
def script_odt_manifest_path(fix_xml_path_path: Path) -> Path:
    return fix_xml_path_path("script_odt_manifest.xml")
